...
const SIDEBAR_WIDTH_ICON = '2.9375rem' // 47px
  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
          overflowing ? 'w-12' : '',
          'relative group peer hidden md:block text-sidebar-foreground h-full',
          'shrink-0'
        )}
        data-state={state}
        ...
        data-side={side}
      >
        {/* This is what handles the sidebar gap on desktop - keeps layout fixed */}
        <div
          className={cn(
            overflowing ? 'absolute top-0' : 'relative',
            'duration-100 h-full bg-transparent transition-[width] ease-linear',
            'group-data-[collapsible=offcanvas]:w-0',
            'group-data-[side=right]:rotate-180',
            state === 'collapsed'
              ? 'w-(--sidebar-width-icon) border-r border-neutral-200 dark:border-neutral-800'
              : variant === 'floating' || variant === 'inset'
              ? 'group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4)))]'
              : 'w-(--sidebar-width) border-r border-neutral-200 dark:border-neutral-800'
          )}
        />
        ...
        <div
          ...
          className={cn(
            ...
            'duration-200 inset-y-0 z-20 hidden transition-[left,right,width,box-shadow] ease-in-out md:flex',
            side === 'left'
              ? 'left-0 group-data-[collapsible=offcanvas]:-left-(--sidebar-width)'
              : 'right-0 group-data-[collapsible=offcanvas]:-right-(--sidebar-width)',
            // Overlay effect: when collapsed and hovered, expand over content with z-40 and shadow!
            state === 'collapsed'
              ? isHovered
                ? 'w-(--sidebar-width) z-40 shadow-2xl group-data-[side=left]:border-r group-data-[side=left]:border-neutral-200 dark:group-data-[side=left]:border-neutral-800 group-data-[side=right]:border-l group-data-[side=right]:border-neutral-200 dark:group-data-[side=right]:border-neutral-800'
                : 'w-(--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=left]:border-neutral-200 dark:group-data-[side=left]:border-neutral-800 group-data-[side=right]:border-l group-data-[side=right]:border-neutral-200 dark:group-data-[side=right]:border-neutral-800'
              : variant === 'floating' || variant === 'inset'
              ? 'p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)]'
              : 'w-(--sidebar-width) group-data-[side=left]:border-r group-data-[side=left]:border-neutral-200 dark:group-data-[side=left]:border-neutral-800 group-data-[side=right]:border-l group-data-[side=right]:border-neutral-200 dark:group-data-[side=right]:border-neutral-800',
            className
          )}
          {...props}
        >
